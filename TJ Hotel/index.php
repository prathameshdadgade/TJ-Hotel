    ...
    <div class="swiper-wrapper mb-5">
      <div class="swiper-slide bg-white mb-3">
        <div class="profile d-flex align-items-center p-4">
          <img src="images/" width="10px" >
          <h6 m-0 ms-2>Random User1</h6>
        </div>
        <p>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
          Pariatur, inventore. Dolore temporibus mollitia magnam non 
          ratione harum impedit iure ducimus omnis eius rem corporis,
           voluptas quasi facilis vitae velit commodi.
        </p>
        <div class="rating">
          <i class="bi bi-star-fill text-warning"></i>
          <i class="bi bi-star-fill text-warning"></i>
